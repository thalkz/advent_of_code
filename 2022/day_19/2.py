...
class Factory:
    ...
    def should_build(self, robot_id) -> bool:
        if robot_id == 0:
                ...
                return self.robots[1] < self.blueprint.robot_costs[2][1] and self.resources[1] < self.blueprint.robot_costs[2][1]+1
        elif robot_id == 2:
                return self.robots[2] < self.blueprint.robot_costs[3][2] and self.resources[2] < self.blueprint.robot_costs[3][2]+1
        elif robot_id == 3:
                return True
...
def step(factory: Factory) -> int:
    ...
    if call_count % 1_000_000 == 0:
        print("call_count", call_count)

    # print(factory.time)
    # if str(factory) in visited[factory.time]:
    #     return 0
    # visited[time][str(factory)] = True
...
print("total qualities", qualities)
