...
for i in range(10000):
    for m in monkeys:
        for _ in range(len(m.items)):
            ...
            # Note: all monkeys tests are primary number
            # d is divided by all monkey tests,
            # therefore adding or subtracting d to our worry level does not change any test result
            # this is why we apply modulo d to our current worry level
            x = x % d
