...
first = traverse(start=(0, -1), entrypoint=(0, 0),
                 out=(x_size-1, y_size-1), start_dist=0)
print("first", first)

second = traverse(start=(x_size-1, y_size), entrypoint=(x_size-1, y_size-1),
                  out=(0,0), start_dist=first)
print("second", second)

second = traverse(start=(0, -1), entrypoint=(0, 0),
                  out=(x_size-1, y_size-1), start_dist=second)
print("third", second)
