...
func distance(_ galaxies: [Point], _ spaceX: Set<Int>, _ spaceY: Set<Int>, _ i: Int, _ j: Int, expantion: Int) -> Int {
...
for i in 0..<galaxies.count {
    for j in (i+1)..<galaxies.count {
        let dist = distance(galaxies, spaceX, spaceY, i, j, expantion: 1000000)
